...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "About — Panchariya Labs" },
      { property: "og:description", content: "Freelance web developer based in Bengaluru, working worldwide." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "/about" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "About — Panchariya Labs" },
      { name: "twitter:description", content: "Freelance web developer based in Bengaluru, working worldwide." },
    ],
    links: [{ rel: "canonical", href: "/about" }],
    scripts: ldScripts({ name: "About — Panchariya Labs", description: "Freelance web developer based in Bengaluru, working worldwide.", path: "/about" }),
  }),
