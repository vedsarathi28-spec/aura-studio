...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Panchariya Labs" },
      { name: "theme-color", content: "#1a0b2e" },
      { property: "og:title", content: "Panchariya Labs — Premium Freelance Web Developer" },
      { property: "og:description", content: "Modern websites that grow businesses. Custom builds, end-to-end design, deployed in days." },
      ...
      { name: "twitter:description", content: "Modern websites that grow businesses. Custom builds, end-to-end design, deployed in days." },
      { name: "apple-mobile-web-app-title", content: "Panchariya Labs" },
      { name: "application-name", content: "Panchariya Labs" },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/4f8573ab-0e2a-4188-b6b8-49c21a22f0e2/id-preview-9ba47758--84f2635a-6a1f-4c8c-b43f-695f6fc44fc7.lovable.app-1783602393923.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/4f8573ab-0e2a-4188-b6b8-49c21a22f0e2/id-preview-9ba47758--84f2635a-6a1f-4c8c-b43f-695f6fc44fc7.lovable.app-1783602393923.png" },
    ],
    links: [
